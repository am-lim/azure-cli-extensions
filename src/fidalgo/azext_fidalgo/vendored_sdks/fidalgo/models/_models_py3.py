...
class Catalog(Resource):
    ...
    _attribute_map = {
        ...
        'last_sync_time': {'key': 'properties.lastSyncTime', 'type': 'str'},
    }
...
class CatalogProperties(CatalogUpdateProperties):
    ...
    _attribute_map = {
        ...
        'last_sync_time': {'key': 'lastSyncTime', 'type': 'str'},
    }
...
class MachineDefinition(TrackedResource):
    ...
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~fidalgo.models.SystemData
    :param image_type: The image type. Possible values include: "Custom", "Gallery".
    :type image_type: str or ~fidalgo.models.ImageType
    :param image_id: The image identifier of the virtual machine image.
    :type image_id: str
    :ivar provisioning_state: The provisioning state of the resource.
    :vartype provisioning_state: str
    """
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        image_type: Optional[Union[str, "ImageType"]] = None,
...
class MachineDefinitionProperties(MachineDefinitionUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MachineDefinitionProperties, self).__init__(image_type=image_type, image_id=image_id, **kwargs)
        self.provisioning_state = None
...
class NetworkSettingsUpdateProperties(msrest.serialization.Model):
    ...
    :param virtual_network_id: Resource id of a vnet to join virtual machines in the pool to.
...
class NetworkProperties(NetworkSettingsUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(NetworkProperties, self).__init__(virtual_network_id=virtual_network_id, subnet_id=subnet_id, networking_resource_group_id=networking_resource_group_id, domain_name=domain_name, organization_unit=organization_unit, domain_username=domain_username, domain_password=domain_password, **kwargs)
        self.provisioning_state = None
