...
def cf_fidalgo_cl(cli_ctx, *_):
    from azure.cli.core.commands.client_factory import get_mgmt_service_client
    from azext_fidalgo.vendored_sdks.fidalgo import Fidalgo
    return get_mgmt_service_client(cli_ctx,
                                   Fidalgo)


def cf_dev_center(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).dev_centers
...
def cf_deployment(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).deployments


def cf_environment_type(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).environment_types
...
def cf_pool(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).pools


def cf_machine_definition(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).machine_definitions


def cf_network_setting(cli_ctx, *_):
    return cf_fidalgo_cl(cli_ctx).network_settings
