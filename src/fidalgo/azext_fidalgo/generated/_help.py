...
helps['fidalgo machine-definition create'] = """
    ...
    examples:
      - name: MachineDefinitions_CreateWithCustomImage
        text: |-
               az fidalgo machine-definition create --location "centralus" --image-id "/subscriptions/0ac520ee-14c0-480\
f-b6c9-0a90c58ffff/resourceGroups/Example/providers/Microsoft.Compute/images/exampleImage" --image-type "Custom" \
...
helps['fidalgo machine-definition update'] = """
    ...
    examples:
      - name: MachineDefinitions_Patch
        text: |-
               az fidalgo machine-definition update --image-id "/subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/reso\
urceGroups/Example/providers/Microsoft.Compute/images/image2" --name "{machineDefinitionName}" --resource-group "rg1"
"""
...
irtualNetworks/ExampleVNet/subnets/default" --virtual-network-id "/subscriptions/00000000-0000-0000-0000-000000000000/r\
esourceGroups/ExampleRG/providers/Microsoft.Network/virtualNetworks/ExampleVNet" --name "{networkSettingName}" \
--resource-group "rg1"
"""
