...
def call_scenario(test):
    ...
    step_machine_definition_create(test, checks=[
        test.check("location", "centralus", case_sensitive=False),
        test.check("imageId", "/subscriptions/{subscription_id}/resourceGroups/{rg_2}/providers/Microsoft.Compute/image"
                   "s/exampleImage", case_sensitive=False),
        test.check("imageType", "Custom", case_sensitive=False),
    ...
    step_network_setting_create(test, checks=[
        ...
        test.check("virtualNetworkId", "/subscriptions/{subscription_id}/resourceGroups/{rg_3}/providers/Microsoft.Netw"
                   "ork/virtualNetworks/{vn}", case_sensitive=False),
