...
def step_machine_definition_create(test, checks=None):
    ...
    test.cmd('az fidalgo machine-definition create '
             '--location "centralus" '
             '--image-id "/subscriptions/{subscription_id}/resourceGroups/{rg_2}/providers/Microsoft.Compute/images/exa'
             'mpleImage" '
             '--image-type "Custom" '
...
def step_machine_definition_update(test, checks=None):
    ...
    test.cmd('az fidalgo machine-definition update '
             '--image-id "/subscriptions/{subscription_id}/resourceGroups/{rg_2}/providers/Microsoft.Compute/images/ima'
             'ge2" '
             '--name "{myMachineDefinition}" '
             '--resource-group "{rg}"',
             checks=checks)
...
def step_network_setting_create(test, checks=None):
    ...
    test.cmd('az fidalgo network-setting create '
             ...
             '--virtual-network-id "/subscriptions/{subscription_id}/resourceGroups/{rg_3}/providers/Microsoft.Network/'
             'virtualNetworks/{vn}" '
