...
@register_command(
    "devcenter admin project-catalog image-definition-build get-build-detail",
    is_preview=True,
)
class GetBuildDetail(AAZCommand):
    """Gets Build details

    :example: Get build detail
        az devcenter admin project-catalog image-definition-build get-build-detail --build-name  --catalog-name "CentralCatalog" --image-definition-name "DefaultDevImage" --project-name "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/catalogs/{}/imagedefinitions/{}/builds/{}/getbuilddetails", "2024-07-01-preview"],
        ]
    }
