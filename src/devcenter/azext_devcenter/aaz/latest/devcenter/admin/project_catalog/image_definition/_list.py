...
@register_command(
    "devcenter admin project-catalog image-definition list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: List
        az devcenter admin project-catalog image-definition list --catalog-name "CentralCatalog" --project-name "DevProject" --resource-group "rg1"
    """
