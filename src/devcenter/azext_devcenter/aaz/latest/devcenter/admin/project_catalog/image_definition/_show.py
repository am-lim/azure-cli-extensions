...
@register_command(
    "devcenter admin project-catalog image-definition show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    :example: Show
        az devcenter admin project-catalog image-definition show --catalog-name "CentralCatalog" --image-definition-name "DefaultDevImage" --project-name "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/catalogs/{}/imagedefinitions/{}", "2024-07-01-preview"],
        ]
    }
