...
@register_command(
    "devcenter admin project-catalog image-definition-build list",
    is_preview=True,
)
class List(AAZCommand):
    ...
    :example: List
        az devcenter admin project-catalog image-definition-build list --catalog-name "CentralCatalog" --image-definition-name "DefaultDevImage" --project-name "DevProject" --resource-group "rg1"
    """
