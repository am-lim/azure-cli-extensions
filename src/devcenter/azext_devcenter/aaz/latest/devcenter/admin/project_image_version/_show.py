...
class Show(AAZCommand):
    ...
    :example: Show
        az devcenter admin project-image-version show --project-name "DevProject" --resource-group "rg1" --image-name "~gallery~DefaultDevGallery~ContosoBaseImage" --version-name "1.0.0"
    """

    _aaz_info = {
        "version": "2024-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/images/{}/versions/{}", "2024-07-01-preview"],
        ]
    }
