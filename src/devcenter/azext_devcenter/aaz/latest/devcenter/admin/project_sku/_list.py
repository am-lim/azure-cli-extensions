...
class List(AAZCommand):
    ...
    :example: List
        az devcenter admin project-sku list --project "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.devcenter/projects/{}/listskus", "2024-07-01-preview"],
        ]
    }
