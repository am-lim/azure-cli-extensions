...
@register_command(
    "devcenter-private-rp admin pool run-health-check",
)
class RunHealthCheck(AAZCommand):
    """Triggers a refresh of the pool status.

    :example: Run health check
        az devcenter-private-rp admin pool run-health-check --name "DevPool" --project-name "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/projects/{}/pools/{}/runhealthchecks", "2024-05-01-preview"],
        ]
    }
