...
@register_command(
    "devcenter-private-rp admin pool update",
)
class Update(AAZCommand):
    """Update a pool.

    :example: Update
        az devcenter-private-rp admin pool update --devbox-definition-name "WebDevBox2" --pool-name "DevPool" --project-name "DevProject" --resource-group "rg1" --stop-on-disconnect status="Disabled"
    """
