...
@register_command(
    "devcenter-private-rp admin catalog-task get-error-detail",
)
class GetErrorDetail(AAZCommand):
    """Gets customization task error details.

    :example: Get error detail
        az devcenter-private-rp admin catalog-task get-error-detail --catalog-name "CentralCatalog" --task-name "SampleTask" --dev-center-name "Contoso" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/catalogs/{}/tasks/{}/geterrordetails", "2024-05-01-preview"],
        ]
    }
    ...
    class CustomizationTasksGetErrorDetails(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/catalogs/{catalogName}/tasks/{taskName}/getErrorDetails",
                **self.url_parameters
            )
