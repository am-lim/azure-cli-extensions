...
@register_command(
    "devcenter-private-rp admin project update",
)
class Update(AAZCommand):
    """Update a project.

    :example: Update
        az devcenter-private-rp admin project update --description "This is my first project." --tags CostCenter="R&D" --name "DevProject" --resource-group "rg1" --max-dev-boxes-per-user "5"
    """
