...
@register_command(
    "devcenter-private-rp admin project get-inherited-setting",
)
class GetInheritedSetting(AAZCommand):
    """Gets applicable inherited settings for this project.

    :example: Get inherited settings
        az devcenter-private-rp admin project get-inherited-setting --name "DevProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/projects/{}/getinheritedsettings", "2024-05-01-preview"],
        ]
    }
    ...
    class ProjectsGetInheritedSettings(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/getInheritedSettings",
                **self.url_parameters
            )
