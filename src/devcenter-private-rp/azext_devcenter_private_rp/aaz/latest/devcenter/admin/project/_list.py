...
@register_command(
    "devcenter-private-rp admin project list",
)
class List(AAZCommand):
    """List projects.

    :example: List by resource group
        az devcenter-private-rp admin project list --resource-group "rg1"

    :example: List by subscription
        az devcenter-private-rp admin project list
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/private.devcenter/projects", "2024-05-01-preview"],
