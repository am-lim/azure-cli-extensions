...
@register_command(
    "devcenter-private-rp admin usage list",
)
class List(AAZCommand):
    """List the current usages and limits in this location for the provided subscription.

    :example: List
        az devcenter-private-rp admin usage list --location "westus3"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/private.devcenter/locations/{}/usages", "2024-05-01-preview"],
        ]
    }
    ...
    class UsagesListByLocation(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Private.DevCenter/locations/{location}/usages",
                **self.url_parameters
            )
