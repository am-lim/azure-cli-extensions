...
@register_command(
    "devcenter-private-rp admin plan-member show",
    is_preview=True,
)
class Show(AAZCommand):
    ...
    :example: Get
        az devcenter-private-rp admin plan-member show --name "d702f662-b3f2-4796-9e8c-13c22378ced3" --plan-name "ContosoPlan" --resource-group "rg1"
    """
