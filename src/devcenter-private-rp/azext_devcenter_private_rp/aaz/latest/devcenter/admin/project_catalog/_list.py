...
@register_command(
    "devcenter-private-rp admin project-catalog list",
)
class List(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/projects/{}/catalogs", "2024-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProjectCatalogsList(ctx=self.ctx)()
    ...
    class ProjectCatalogsList(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/catalogs",
                **self.url_parameters
            )
