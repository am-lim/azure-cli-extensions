...
@register_command(
    "devcenter-private-rp admin project-catalog get-sync-error-detail",
)
class GetSyncErrorDetail(AAZCommand):
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/projects/{}/catalogs/{}/getsyncerrordetails", "2024-05-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ProjectCatalogsGetSyncErrorDetails(ctx=self.ctx)()
    ...
    class ProjectCatalogsGetSyncErrorDetails(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/catalogs/{catalogName}/getSyncErrorDetails",
                **self.url_parameters
            )
