...
@register_command(
    "devcenter-private-rp admin devbox-definition update",
)
class Update(AAZCommand):
    """Update a dev box definition.

    :example: Update
        az devcenter-private-rp admin devbox-definition update --image-reference id="/subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/Example/providers/Private.DevCenter/devcenters/Contoso/galleries/contosogallery/images/exampleImage/version/2.0.0" --name "WebDevBox" --dev-center-name "Contoso" --resource-group "rg1"
    """
    ...
    class DevBoxDefinitionsGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_dev_box_definition_read(cls._schema_on_200)
    ...
    class DevBoxDefinitionsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_dev_box_definition_read(cls._schema_on_200_201)
