...
@register_command(
    "devcenter-private-rp admin devbox-definition list",
)
class List(AAZCommand):
    """List dev box definitions configured for a dev center or project.

    :example: List by dev center
        az devcenter-private-rp admin devbox-definition list --dev-center-name "Contoso" --resource-group "rg1"

    :example: List by project
        az devcenter-private-rp admin devbox-definition list --project-name "ContosoProject" --resource-group "rg1"
    """
    ...
    class DevBoxDefinitionsListByDevCenter(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/devboxdefinitions",
                **self.url_parameters
            )
