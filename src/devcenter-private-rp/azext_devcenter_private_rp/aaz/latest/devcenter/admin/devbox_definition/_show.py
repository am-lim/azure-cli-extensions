...
@register_command(
    "devcenter-private-rp admin devbox-definition show",
)
class Show(AAZCommand):
    """Get a dev box definition configured for a dev center or a project.

    :example: Get a dev center dev box definition
        az devcenter-private-rp admin devbox-definition show --name "WebDevBox" --dev-center-name "Contoso" --resource-group "rg1"

    :example: Get a project dev box definition
        az devcenter-private-rp admin devbox-definition show --name "WebDevBox" --project-name "ContosoProject" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/devboxdefinitions/{}", "2024-05-01-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/projects/{}/devboxdefinitions/{}", "2024-05-01-preview"],
        ]
    }
    ...
    class DevBoxDefinitionsGetByProject(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/devboxdefinitions/{devBoxDefinitionName}",
                **self.url_parameters
            )
    ...
    class DevBoxDefinitionsGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/devboxdefinitions/{devBoxDefinitionName}",
                **self.url_parameters
            )
