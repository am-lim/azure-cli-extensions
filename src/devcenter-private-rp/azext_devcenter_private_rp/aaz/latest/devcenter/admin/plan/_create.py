...
@register_command(
    "devcenter-private-rp admin plan create",
    is_preview=True,
)
class Create(AAZCommand):
    ...
    :example: Create
        az devcenter-private-rp admin plan create --name "ContosoPlan" --location "eastus" --resource-group "myResourceGroup" --sku name="CCOG_Standard"  --tags CostCode="12345"
    """
    ...
    class PlansCreateOrUpdate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/plans/{planName}",
                **self.url_parameters
            )
