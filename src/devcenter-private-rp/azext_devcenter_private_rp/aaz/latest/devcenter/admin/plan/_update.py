...
@register_command(
    "devcenter-private-rp admin plan update",
    is_preview=True,
)
class Update(AAZCommand):
    ...
    :example: Update
        az devcenter-private-rp admin plan update --name "ContosoPlan" --resource-group "myResourceGroup" --sku name="CCOG_Standard"  --tags CostCode="12345"
    """
