...
@register_command(
    "devcenter-private-rp admin network-connection list-health-check",
)
class ListHealthCheck(AAZCommand):
    """List health check status details

    :example: List health check status details
        az devcenter-private-rp admin network-connection list-health-check --name "uswest3network" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/networkconnections/{}/healthchecks", "2024-05-01-preview"],
        ]
    }
    ...
    class NetworkConnectionsListHealthDetails(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/networkConnections/{networkConnectionName}/healthChecks",
                **self.url_parameters
            )
