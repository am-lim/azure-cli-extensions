...
@register_command(
    "devcenter-private-rp admin network-connection list-outbound-network-dependencies-endpoint",
)
class ListOutboundNetworkDependenciesEndpoint(AAZCommand):
    ...
    :example: List outbound network dependencies endpoint
        az devcenter-private-rp admin network-connection list-outbound-network-dependencies-endpoint --name "uswest3network" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/networkconnections/{}/outboundnetworkdependenciesendpoints", "2024-05-01-preview"],
        ]
    }
