...
@register_command(
    "devcenter-private-rp admin network-connection show-health-check",
)
class ShowHealthCheck(AAZCommand):
    """Get health check status details.

    :example: Get health check
        az devcenter-private-rp admin network-connection show-health-check--name "uswest3network" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/networkconnections/{}/healthchecks/latest", "2024-05-01-preview"],
        ]
    }
    ...
    class NetworkConnectionsGetHealthDetails(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/networkConnections/{networkConnectionName}/healthChecks/latest",
                **self.url_parameters
            )
