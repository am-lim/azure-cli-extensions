...
@register_command(
    "devcenter-private-rp admin network-connection update",
)
class Update(AAZCommand):
    """Update a network connection.

    :example: Update
        az devcenter-private-rp admin network-connection update --domain-password "New Password value for user" --name "networkConnection" --resource-group "rg1"
    """
    ...
    class NetworkConnectionsUpdate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/networkConnections/{networkConnectionName}",
                **self.url_parameters
            )
