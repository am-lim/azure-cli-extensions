...
@register_command(
    "devcenter-private-rp admin gallery create",
)
class Create(AAZCommand):
    """Create a gallery.

    :example: Create
        az devcenter-private-rp admin gallery create --gallery-resource-id "/subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.Compute/galleries/StandardGallery" --dev-center-name "Contoso" --name "StandardGallery" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/galleries/{}", "2024-05-01-preview"],
        ]
    }
