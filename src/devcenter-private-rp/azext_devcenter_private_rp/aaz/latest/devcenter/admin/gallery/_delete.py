...
@register_command(
    "devcenter-private-rp admin gallery delete",
...
class Delete(AAZCommand):
    ...
    :example: Delete
        az devcenter-private-rp admin gallery delete --dev-center-name "Contoso" --name "StandardGallery" --resource-group "rg1"
    """
    ...
    class GalleriesDelete(AAZHttpOperation):
