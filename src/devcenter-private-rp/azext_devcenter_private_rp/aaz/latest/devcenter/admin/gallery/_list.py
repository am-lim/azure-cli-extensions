...
@register_command(
    "devcenter-private-rp admin gallery list",
)
class List(AAZCommand):
    """List galleries for a dev center.

    :example: List
        az devcenter-private-rp admin gallery list --dev-center-name "Contoso" --resource-group "rg1"
    """
    ...
    class GalleriesListByDevCenter(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/galleries",
                **self.url_parameters
            )
