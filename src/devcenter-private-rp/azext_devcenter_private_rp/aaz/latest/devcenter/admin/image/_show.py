...
@register_command(
    "devcenter-private-rp admin image show",
)
class Show(AAZCommand):
    """Get a gallery image.

    :example: Get
        az devcenter-private-rp admin image show --dev-center-name "Contoso" --gallery-name "DefaultDevGallery" --name "ContosoBaseImage" --resource-group "rg1"
    """
    ...
    class ImagesGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/galleries/{galleryName}/images/{imageName}",
                **self.url_parameters
            )
