...
@register_command(
    "devcenter-private-rp admin image list",
)
class List(AAZCommand):
    """List images for a dev center or gallery.

    :example: List by dev center
        az devcenter-private-rp admin image list --dev-center-name "Contoso" --resource-group "rg1"

    :example: List by gallery
        az devcenter-private-rp admin image list --dev-center-name "Contoso" --gallery-name "DevGallery" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/galleries/{}/images", "2024-05-01-preview"],
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/images", "2024-05-01-preview"],
        ]
    }
    ...
    class ImagesListByDevCenter(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/images",
                **self.url_parameters
            )
    ...
    class ImagesListByGallery(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/galleries/{galleryName}/images",
                **self.url_parameters
            )
