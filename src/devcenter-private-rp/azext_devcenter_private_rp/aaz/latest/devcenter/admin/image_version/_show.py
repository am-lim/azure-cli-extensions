...
@register_command(
    "devcenter-private-rp admin image-version show",
)
class Show(AAZCommand):
    """Get an image version.

    :example: Get
        az devcenter-private-rp admin image-version show --dev-center-name "Contoso" --gallery-name "DefaultDevGallery" --image-name "Win11" --resource-group "rg1" --version-name "1.0.0"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/galleries/{}/images/{}/versions/{}", "2024-05-01-preview"],
        ]
    }
    ...
    class ImageVersionsGet(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/galleries/{galleryName}/images/{imageName}/versions/{versionName}",
                **self.url_parameters
            )
