...
@register_command(
    "devcenter-private-rp admin image-version list",
)
class List(AAZCommand):
    """List versions for an image.

    :example: List
        az devcenter-private-rp admin image-version list --dev-center-name "Contoso" --gallery-name "DefaultDevGallery" --image-name "Win11" --resource-group "rg1"
    """
    ...
    class ImageVersionsListByImage(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/galleries/{galleryName}/images/{imageName}/versions",
                **self.url_parameters
            )
