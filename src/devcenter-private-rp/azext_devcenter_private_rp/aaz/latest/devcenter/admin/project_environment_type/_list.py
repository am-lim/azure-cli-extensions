...
@register_command(
    "devcenter-private-rp admin project-environment-type list",
)
class List(AAZCommand):
    """List environment types for a project.

    :example: List
        az devcenter-private-rp admin project-environment-type list --project-name "ContosoProj" --resource-group "rg1"
    """
