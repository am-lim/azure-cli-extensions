...
@register_command(
    "devcenter-private-rp admin project-environment-type show",
)
class Show(AAZCommand):
    """Get a project environment type.

    :example: Get
        az devcenter-private-rp admin project-environment-type show --environment-type-name "DevTest" --project-name "ContosoProj" --resource-group "rg1"
    """
