...
class Create(AAZCommand):
    ...
    _args_environment_role_create = None

    @classmethod
    def _build_args_environment_role_create(cls, _schema):
        if cls._args_environment_role_create is not None:
            return

        cls._args_environment_role_create = AAZObjectArg(
            blank={},
        )
    ...
    class ProjectEnvironmentTypesCreateOrUpdate(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/environmentTypes/{environmentTypeName}",
                **self.url_parameters
            )
        ...
        def content(self):
            ...
            if roles is not None:
                _CreateHelper._build_schema_environment_role_create(roles.set_elements(AAZObjectType, "."))
...
class _CreateHelper:
    ...
    @classmethod
    def _build_schema_environment_role_create(cls, _builder):
        if _builder is None:
            return
