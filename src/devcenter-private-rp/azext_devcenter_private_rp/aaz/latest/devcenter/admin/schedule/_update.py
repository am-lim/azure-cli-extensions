...
@register_command(
    "devcenter-private-rp admin schedule update",
)
class Update(AAZCommand):
    """Update a schedule.

    :example: Update
        az devcenter-private-rp admin schedule update --time "18:00" --pool-name "DevPool" --project-name "TestProject" --resource-group "rg1"
    """
