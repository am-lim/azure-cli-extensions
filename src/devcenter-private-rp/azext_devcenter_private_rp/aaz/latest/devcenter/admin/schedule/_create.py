...
@register_command(
    "devcenter-private-rp admin schedule create",
)
class Create(AAZCommand):
    """Create a schedule.

    :example: Create
        az devcenter-private-rp admin schedule create --state "Enabled" --time "17:30" --time-zone "America/Los_Angeles" --pool-name "DevPool" --project-name "DevProject" --resource-group "rg1"
    """
