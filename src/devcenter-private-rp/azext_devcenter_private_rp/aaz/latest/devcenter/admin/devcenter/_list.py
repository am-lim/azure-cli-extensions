...
@register_command(
    "devcenter-private-rp admin devcenter list",
)
class List(AAZCommand):
    """List all dev centers in a resource group.

    :example: List by resource group
        az devcenter-private-rp admin devcenter list --resource-group "rg1"

    :example: List by subscription
        az devcenter-private-rp admin devcenter list
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/private.devcenter/devcenters", "2024-05-01-preview"],
    ...
    class DevCentersListByResourceGroup(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters",
                **self.url_parameters
            )
    ...
    class DevCentersListBySubscription(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/providers/Private.DevCenter/devcenters",
                **self.url_parameters
            )
