...
@register_command(
    "devcenter-private-rp admin devcenter update",
)
class Update(AAZCommand):
    """Update a dev center.

    :example: Update
        az devcenter-private-rp admin devcenter update --tags CostCode="12345" --name "Contoso" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}", "2024-05-01-preview"],
        ]
    }
    ...
    class DevCentersGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _UpdateHelper._build_schema_dev_center_read(cls._schema_on_200)
    ...
    class DevCentersCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_dev_center_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    _schema_dev_center_read = None

    @classmethod
    def _build_schema_dev_center_read(cls, _schema):
        if cls._schema_dev_center_read is not None:
            _schema.id = cls._schema_dev_center_read.id
            _schema.identity = cls._schema_dev_center_read.identity
            _schema.location = cls._schema_dev_center_read.location
            _schema.name = cls._schema_dev_center_read.name
            _schema.properties = cls._schema_dev_center_read.properties
            _schema.system_data = cls._schema_dev_center_read.system_data
            _schema.tags = cls._schema_dev_center_read.tags
            _schema.type = cls._schema_dev_center_read.type
            return

        cls._schema_dev_center_read = _schema_dev_center_read = AAZObjectType()

        dev_center_read = _schema_dev_center_read
        ...
        dev_center_read.name = AAZStrType(
            flags={"read_only": True},
        )
        dev_center_read.properties = AAZObjectType(
            flags={"client_flatten": True},
        )
        dev_center_read.system_data = AAZObjectType(
            serialized_name="systemData",
            flags={"read_only": True},
        )
        dev_center_read.tags = AAZDictType()
        dev_center_read.type = AAZStrType(
            flags={"read_only": True},
        )

        identity = _schema_dev_center_read.identity
        ...
        user_assigned_identities = _schema_dev_center_read.identity.user_assigned_identities
        user_assigned_identities.Element = AAZObjectType()

        _element = _schema_dev_center_read.identity.user_assigned_identities.Element
        ...
        tags = _schema_dev_center_read.tags
