...
@register_command(
    "devcenter-private-rp admin check-name-availability execute",
)
class Execute(AAZCommand):
    """Check the availability of name for resource.

    :example: Check name availability
        az devcenter-private-rp admin check-name-availability execute --name "name1" --type "Private.DevCenter/devcenters"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/private.devcenter/checknameavailability", "2024-05-01-preview"],
        ]
    }
