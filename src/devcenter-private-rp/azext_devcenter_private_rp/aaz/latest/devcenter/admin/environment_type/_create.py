...
@register_command(
    "devcenter-private-rp admin environment-type create",
)
class Create(AAZCommand):
    """Create an environment type.

    :example: Create
        az devcenter-private-rp admin environment-type create --tags Owner="superuser" --dev-center-name "Contoso" --name "DevTest" --resource-group "rg1"
    """
