...
@register_command(
    "devcenter-private-rp admin environment-type show",
)
class Show(AAZCommand):
    """Get an environment type.

    :example: Get
        az devcenter-private-rp admin environment-type show --dev-center-name "Contoso" --name "DevTest" --resource-group "rg1"
    """
