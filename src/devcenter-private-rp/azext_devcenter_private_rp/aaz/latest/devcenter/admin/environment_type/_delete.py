...
@register_command(
    "devcenter-private-rp admin environment-type delete",
...
class Delete(AAZCommand):
    ...
    :example: Delete
        az devcenter-private-rp admin environment-type delete --dev-center-name "Contoso" --name "DevTest" --resource-group "rg1"
    """
