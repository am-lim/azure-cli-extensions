...
@register_command(
    "devcenter-private-rp admin catalog get-sync-error-detail",
)
class GetSyncErrorDetail(AAZCommand):
    """Gets catalog synchronization error details.

    :example: Get synchronization error detail
        az devcenter-private-rp admin catalog get-sync-error-detail --name "CentralCatalog" --dev-center-name "Contoso" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/catalogs/{}/getsyncerrordetails", "2024-05-01-preview"],
        ]
    }
    ...
    class CatalogsGetSyncErrorDetails(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/catalogs/{catalogName}/getSyncErrorDetails",
                **self.url_parameters
            )
