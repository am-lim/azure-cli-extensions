...
@register_command(
    "devcenter-private-rp admin catalog list",
)
class List(AAZCommand):
    """List catalogs for a dev center.

    :example: List
        az devcenter-private-rp admin catalog list --dev-center-name "Contoso" --resource-group "rg1"
    """
    ...
    class CatalogsListByDevCenter(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/catalogs",
                **self.url_parameters
            )
        ...
        def _build_schema_on_200(cls):
            ...
            synced_catalog_item_types = cls._schema_on_200.value.Element.properties.last_sync_stats.synced_catalog_item_types
