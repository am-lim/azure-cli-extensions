...
@register_command(
    "devcenter-private-rp admin catalog connect",
)
class Connect(AAZCommand):
    """Connects a catalog to enable syncing.

    :example: Connect
        az devcenter-private-rp admin catalog connect --name "CentralCatalog" --dev-center-name "Contoso" --resource-group "rg1"
    """

    _aaz_info = {
        "version": "2024-05-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/catalogs/{}/connect", "2024-05-01-preview"],
        ]
    }
    ...
    class CatalogsConnect(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/catalogs/{catalogName}/connect",
                **self.url_parameters
            )
