...
@register_command(
    "devcenter-private-rp admin catalog update",
)
class Update(AAZCommand):
    """Update a catalog.

    :example: Update
        az devcenter-private-rp admin catalog update --git-hub path="/environments" --name "CentralCatalog" --dev-center-name "Contoso" --resource-group "rg1"
    """
