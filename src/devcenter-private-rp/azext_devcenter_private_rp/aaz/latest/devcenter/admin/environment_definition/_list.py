...
@register_command(
    "devcenter-private-rp admin environment-definition list",
)
class List(AAZCommand):
    """List environment definitions in the catalog.

    :example: List
        az devcenter-private-rp admin environment-definition list --catalog-name "myCatalog" --dev-center "Contoso" --resource-group "rg1"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.EnvironmentDefinitionsListByCatalog(ctx=self.ctx)()
    ...
    class EnvironmentDefinitionsListByCatalog(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/catalogs/{catalogName}/environmentDefinitions",
                **self.url_parameters
            )
