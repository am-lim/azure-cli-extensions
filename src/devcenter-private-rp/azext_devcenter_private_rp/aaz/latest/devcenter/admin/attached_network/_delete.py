...
@register_command(
    "devcenter-private-rp admin attached-network delete",
...
class Delete(AAZCommand):
    ...
    :example: Delete
        az devcenter-private-rp admin attached-network delete --attached-network-connection-name "network-uswest3" --dev-center-name "Contoso" --resource-group "rg1"
    """
