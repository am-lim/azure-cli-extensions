...
@register_command(
    "devcenter-private-rp admin attached-network wait",
)
class Wait(AAZWaitCommand):
    ...
    _aaz_info = {
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.devcenter/devcenters/{}/attachednetworks/{}", "2023-10-01-preview"],
        ]
    }
