...
@register_command(
    "devcenter-private-rp admin attached-network list",
)
class List(AAZCommand):
    """List the attached network connections configured for a dev center or project.

    :example: List by dev center
        az devcenter-private-rp admin attached-network list --dev-center-name "Contoso" --resource-group "rg1"

    :example: List by project
        az devcenter-private-rp admin attached-network list --project-name "DevProject" --resource-group "rg1"
    """
    ...
    class AttachedNetworksListByProject(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/projects/{projectName}/attachednetworks",
                **self.url_parameters
            )
    ...
    class AttachedNetworksListByDevCenter(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.DevCenter/devcenters/{devCenterName}/attachednetworks",
                **self.url_parameters
            )
