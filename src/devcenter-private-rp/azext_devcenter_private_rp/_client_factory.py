...
def cf_devcenter_dataplane(cli_ctx, endpoint=None, dev_center=None, project_name=None):
    ...
    from azext_devcenter_private_rp.vendored_sdks.devcenter_dataplane import (
        DevCenterClient,
    )
    ...
    resource = "23c52867-ddf5-427b-b8a3-868c8a355386"
  
    from azure.cli.core.auth.util import resource_to_scopes
    scopes = resource_to_scopes(resource)
    credential = profile.get_login_credentials(resource=scopes[0])
...
def cf_devcenter_cl(cli_ctx, *_):
    ...
    from azext_devcenter_private_rp.vendored_sdks.devcenter import DevCenter
