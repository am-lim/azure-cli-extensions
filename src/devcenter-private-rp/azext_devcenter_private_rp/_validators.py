...
or endpoint (--endpoint) parameter should be set."""
    ...
    if endpoint is not None:
        check_valid_uri = re.match(
            r"(https)://.+.*\.(devdevcenter.azure-test.net)[/]?$",
            endpoint,
        )
...
'az devcenter-private-rp admin project show' to view the endpoint of a specific project. \
Run 'az devcenter-private-rp admin project list' to view the \
